...
//! Left vertical: tab_bar (1) | tab_content (flex)
...
pub fn draw(frame: &mut Frame, graph: &ConversationGraph, tui_state: &mut TuiState) {
    ...
    render_tab_content(frame, left_col[1], graph, tui_state);
...
fn render_tab_content(
    ...
    match tui_state.nav.active_tab {
        ...
        crate::tui::state::TopTab::System => {
            render_placeholder(frame, area, "System", "(coming soon)");
        }
    }
}

/// Render a placeholder tab with a title and message.
